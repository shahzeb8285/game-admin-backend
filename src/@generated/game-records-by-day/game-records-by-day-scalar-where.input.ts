...
@InputType()
export class game_records_by_dayScalarWhereInput {

    @Field(() => [game_records_by_dayScalarWhereInput], {nullable:true})
    AND?: Array<game_records_by_dayScalarWhereInput>;

    @Field(() => [game_records_by_dayScalarWhereInput], {nullable:true})
    OR?: Array<game_records_by_dayScalarWhereInput>;

    @Field(() => [game_records_by_dayScalarWhereInput], {nullable:true})
    NOT?: Array<game_records_by_dayScalarWhereInput>;
