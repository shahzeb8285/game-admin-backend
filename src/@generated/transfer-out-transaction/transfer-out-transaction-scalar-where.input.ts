...
@InputType()
export class TransferOutTransactionScalarWhereInput {

    @Field(() => [TransferOutTransactionScalarWhereInput], {nullable:true})
    AND?: Array<TransferOutTransactionScalarWhereInput>;

    @Field(() => [TransferOutTransactionScalarWhereInput], {nullable:true})
    OR?: Array<TransferOutTransactionScalarWhereInput>;

    @Field(() => [TransferOutTransactionScalarWhereInput], {nullable:true})
    NOT?: Array<TransferOutTransactionScalarWhereInput>;
