...
import { GameHistoryOrderByWithRelationInput } from '../game-history/game-history-order-by-with-relation.input';

@InputType()
export class GameRebateOrderByWithRelationInput {
    ...
    game_history?: GameHistoryOrderByWithRelationInput;
}
