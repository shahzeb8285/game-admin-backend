...
@InputType()
export class agent_rebate_ratesScalarWhereWithAggregatesInput {

    @Field(() => [agent_rebate_ratesScalarWhereWithAggregatesInput], {nullable:true})
    AND?: Array<agent_rebate_ratesScalarWhereWithAggregatesInput>;

    @Field(() => [agent_rebate_ratesScalarWhereWithAggregatesInput], {nullable:true})
    OR?: Array<agent_rebate_ratesScalarWhereWithAggregatesInput>;

    @Field(() => [agent_rebate_ratesScalarWhereWithAggregatesInput], {nullable:true})
    NOT?: Array<agent_rebate_ratesScalarWhereWithAggregatesInput>;

    @Field(() => StringWithAggregatesFilter, {nullable:true})
    agent_rebate_rate_id?: StringWithAggregatesFilter;
