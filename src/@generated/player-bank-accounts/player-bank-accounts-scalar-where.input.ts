...
@InputType()
export class player_bank_accountsScalarWhereInput {

    @Field(() => [player_bank_accountsScalarWhereInput], {nullable:true})
    AND?: Array<player_bank_accountsScalarWhereInput>;

    @Field(() => [player_bank_accountsScalarWhereInput], {nullable:true})
    OR?: Array<player_bank_accountsScalarWhereInput>;

    @Field(() => [player_bank_accountsScalarWhereInput], {nullable:true})
    NOT?: Array<player_bank_accountsScalarWhereInput>;
