...
@InputType()
export class WithdrawalTransactionScalarWhereWithAggregatesInput {

    @Field(() => [WithdrawalTransactionScalarWhereWithAggregatesInput], {nullable:true})
    AND?: Array<WithdrawalTransactionScalarWhereWithAggregatesInput>;

    @Field(() => [WithdrawalTransactionScalarWhereWithAggregatesInput], {nullable:true})
    OR?: Array<WithdrawalTransactionScalarWhereWithAggregatesInput>;

    @Field(() => [WithdrawalTransactionScalarWhereWithAggregatesInput], {nullable:true})
    NOT?: Array<WithdrawalTransactionScalarWhereWithAggregatesInput>;
