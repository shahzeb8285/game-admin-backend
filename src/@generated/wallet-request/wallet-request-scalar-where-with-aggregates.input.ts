...
@InputType()
export class WalletRequestScalarWhereWithAggregatesInput {

    @Field(() => [WalletRequestScalarWhereWithAggregatesInput], {nullable:true})
    AND?: Array<WalletRequestScalarWhereWithAggregatesInput>;

    @Field(() => [WalletRequestScalarWhereWithAggregatesInput], {nullable:true})
    OR?: Array<WalletRequestScalarWhereWithAggregatesInput>;

    @Field(() => [WalletRequestScalarWhereWithAggregatesInput], {nullable:true})
    NOT?: Array<WalletRequestScalarWhereWithAggregatesInput>;
