...
@InputType()
export class WalletRequestScalarWhereInput {

    @Field(() => [WalletRequestScalarWhereInput], {nullable:true})
    AND?: Array<WalletRequestScalarWhereInput>;

    @Field(() => [WalletRequestScalarWhereInput], {nullable:true})
    OR?: Array<WalletRequestScalarWhereInput>;

    @Field(() => [WalletRequestScalarWhereInput], {nullable:true})
    NOT?: Array<WalletRequestScalarWhereInput>;
