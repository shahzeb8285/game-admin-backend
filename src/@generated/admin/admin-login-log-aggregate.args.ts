...
import { AdminLoginLogWhereInput } from '../admin-login-log/admin-login-log-where.input';
import { Type } from 'class-transformer';
import { AdminLoginLogOrderByWithRelationInput } from '../admin-login-log/admin-login-log-order-by-with-relation.input';
import { AdminLoginLogWhereUniqueInput } from '../admin-login-log/admin-login-log-where-unique.input';
import { Int } from '@nestjs/graphql';
import { AdminLoginLogCountAggregateInput } from '../admin-login-log/admin-login-log-count-aggregate.input';
import { AdminLoginLogMinAggregateInput } from '../admin-login-log/admin-login-log-min-aggregate.input';
import { AdminLoginLogMaxAggregateInput } from '../admin-login-log/admin-login-log-max-aggregate.input';
