...
@InputType()
export class transfer_out_transactionsUpdateWithWhereUniqueWithoutProcessed_by_adminInput {
    ...
    data!: transfer_out_transactionsUpdateWithoutProcessed_by_adminInput;
}
