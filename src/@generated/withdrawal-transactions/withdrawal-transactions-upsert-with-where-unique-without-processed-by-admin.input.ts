...
@InputType()
export class withdrawal_transactionsUpsertWithWhereUniqueWithoutProcessed_by_adminInput {
    ...
    update!: withdrawal_transactionsUpdateWithoutProcessed_by_adminInput;
