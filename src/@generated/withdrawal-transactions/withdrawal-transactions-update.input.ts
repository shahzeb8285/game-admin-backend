...
import { admin_bank_accountsUpdateOneRequiredWithoutWithdrawal_transactionsNestedInput } from '../admin-bank-accounts/admin-bank-accounts-update-one-required-without-withdrawal-transactions-nested.input';
...
export class withdrawal_transactionsUpdateInput {
    ...
    @Field(() => admin_bank_accountsUpdateOneRequiredWithoutWithdrawal_transactionsNestedInput, {nullable:true})
    admin_bank_accounts?: admin_bank_accountsUpdateOneRequiredWithoutWithdrawal_transactionsNestedInput;
}
