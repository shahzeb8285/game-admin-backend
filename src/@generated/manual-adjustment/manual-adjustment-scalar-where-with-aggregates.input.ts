...
@InputType()
export class ManualAdjustmentScalarWhereWithAggregatesInput {

    @Field(() => [ManualAdjustmentScalarWhereWithAggregatesInput], {nullable:true})
    AND?: Array<ManualAdjustmentScalarWhereWithAggregatesInput>;

    @Field(() => [ManualAdjustmentScalarWhereWithAggregatesInput], {nullable:true})
    OR?: Array<ManualAdjustmentScalarWhereWithAggregatesInput>;

    @Field(() => [ManualAdjustmentScalarWhereWithAggregatesInput], {nullable:true})
    NOT?: Array<ManualAdjustmentScalarWhereWithAggregatesInput>;
