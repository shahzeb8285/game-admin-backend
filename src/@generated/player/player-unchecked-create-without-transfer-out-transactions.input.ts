...
import { WithdrawalTransactionUncheckedCreateNestedManyWithoutPlayersInput } from '../withdrawal-transaction/withdrawal-transaction-unchecked-create-nested-many-without-players.input';
...
@InputType()
export class PlayerUncheckedCreateWithoutTransfer_out_transactionsInput {
    ...
    @Field(() => WithdrawalTransactionUncheckedCreateNestedManyWithoutPlayersInput, {nullable:true})
    withdrawal_transactions?: WithdrawalTransactionUncheckedCreateNestedManyWithoutPlayersInput;
