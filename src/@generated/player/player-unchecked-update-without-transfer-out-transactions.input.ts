...
import { TransferInTransactionUncheckedUpdateManyWithoutPlayersNestedInput } from '../transfer-in-transaction/transfer-in-transaction-unchecked-update-many-without-players-nested.input';

@InputType()
export class PlayerUncheckedUpdateWithoutTransfer_out_transactionsInput {
    ...
    @Field(() => TransferInTransactionUncheckedUpdateManyWithoutPlayersNestedInput, {nullable:true})
    transfer_in_transactions?: TransferInTransactionUncheckedUpdateManyWithoutPlayersNestedInput;
}
