...
import { PlayerWalletCreateNestedManyWithoutPlayersInput } from '../player-wallet/player-wallet-create-nested-many-without-players.input';
...
@InputType()
export class PlayerCreateWithoutTransfer_out_transactionsInput {
    ...
    @Field(() => PlayerWalletCreateNestedManyWithoutPlayersInput, {nullable:true})
    player_wallets?: PlayerWalletCreateNestedManyWithoutPlayersInput;
