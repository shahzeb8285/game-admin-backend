...
import { TransferInTransactionUpdateManyWithoutPlayersNestedInput } from '../transfer-in-transaction/transfer-in-transaction-update-many-without-players-nested.input';

@InputType()
export class PlayerUpdateWithoutTransfer_out_transactionsInput {
    ...
    @Field(() => TransferInTransactionUpdateManyWithoutPlayersNestedInput, {nullable:true})
    transfer_in_transactions?: TransferInTransactionUpdateManyWithoutPlayersNestedInput;
}
