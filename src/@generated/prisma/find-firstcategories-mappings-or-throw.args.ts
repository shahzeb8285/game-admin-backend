...
@ArgsType()
export class FindFirstcategoriesMappingsOrThrowArgs {
    ...
    @Field(() => [Categories_mappingsScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Categories_mappingsScalarFieldEnum>;
}
