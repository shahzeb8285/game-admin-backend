...
@InputType()
export class TransferInTransactionScalarWhereInput {

    @Field(() => [TransferInTransactionScalarWhereInput], {nullable:true})
    AND?: Array<TransferInTransactionScalarWhereInput>;

    @Field(() => [TransferInTransactionScalarWhereInput], {nullable:true})
    OR?: Array<TransferInTransactionScalarWhereInput>;

    @Field(() => [TransferInTransactionScalarWhereInput], {nullable:true})
    NOT?: Array<TransferInTransactionScalarWhereInput>;
